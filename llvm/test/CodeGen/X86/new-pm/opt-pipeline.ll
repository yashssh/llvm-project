...
; CHECK-NEXT: Running analysis: InnerAnalysisManagerProxy
; CHECK-NEXT: Running pass: LoopStrengthReducePass
; CHECK-NEXT: Running analysis: IVUsersAnalysis
...
; CHECK-NEXT: Clearing all analysis results for
...
; CHECK-NEXT: Invalidating analysis: InnerAnalysisManagerProxy
...
; CHECK-NEXT: Running pass: FreeMachineFunctionPass
